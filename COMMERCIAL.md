...
- **Small companies** — companies with **fewer than 50 employees & contractors** AND **less than JPY 500,000,000 annual revenue**

If your situation falls under any of the above, you can use ABG in production at no charge. No registration required.

## When a commercial license is required

If your company exceeds the free-use threshold (50 employees / JPY 500M revenue) and you intend to use ABG for commercial purposes, please get in touch. We'd love to hear how you'd like to use ABG, and we'll work with you on terms that fit your situation.

## How to start the conversation

Email **`license@arcm.co.jp`** with a few lines:

1. Your organization name and where you're based
2. How you'd like to use ABG (one or two sentences)
3. Anything specific you need (term length, support, etc.) — optional

We'll respond within a few business days.

## Pricing

ABG is early. We'd rather find great first commercial customers than maximize revenue today. Pricing is **case-by-case** and we'll work with you to find an arrangement that fits.
