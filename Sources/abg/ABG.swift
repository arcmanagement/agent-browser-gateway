...
struct ABG: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [
            ...
            Frames.self, Read.self, Get.self, Find.self, Snapshot.self, Screenshot.self, PDF.self, Annotate.self, Console.self, Eval.self, Table.self, Describe.self, Network.self, HAR.self, Download.self, Dialog.self,
...
private let builtInTopLevelCommands: Set<String> = [
    "status", "tabs", "inspect",
    "frames", "read", "get", "find", "snapshot", "screenshot", "pdf", "annotate", "console", "eval", "table", "describe", "network", "har", "download", "dialog",
