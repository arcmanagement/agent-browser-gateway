...
- macOS app: signed and notarized `v0.4.2` DMG on the download page and GitHub Releases
- Chrome extension: `v0.4.3` on the Chrome Web Store, updated July 11, 2026
...
version `0.4.3`, updated July 11, 2026.
