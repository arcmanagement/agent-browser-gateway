...
- macOS app: signed and notarized `v0.4.4` DMG on the download page and GitHub Releases
...
Current `v0.4.4` status: this package is not indexed yet, and the command above returns no matching
