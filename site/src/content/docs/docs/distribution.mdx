...
- macOS app: signed and notarized `v0.4.6` DMG on GitHub Releases
...
Current `v0.4.6` status: this package is not indexed yet, and the command above returns no matching
