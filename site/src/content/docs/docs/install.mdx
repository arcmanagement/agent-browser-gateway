...
The current public DMG is `agent-browser-gateway-0.4.1-macos-arm64.dmg`.
...
Current `v0.4.1` status: WinGet is not indexed yet, and no Windows release ZIP is published yet. If
...
Current `v0.4.1` status: the Chrome Web Store listing is live and should report extension version
`0.4.1`.
