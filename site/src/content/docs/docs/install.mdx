...
Current `v0.4.6` status: WinGet is not indexed yet, and no Windows release ZIP is published yet. If
...
for normal Chrome use. The public listing currently serves extension `v0.4.4`. For local extension
