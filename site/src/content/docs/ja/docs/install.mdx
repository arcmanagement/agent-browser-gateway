...
現在のpublic DMGは `agent-browser-gateway-0.4.1-macos-arm64.dmg` です。
...
現在の `v0.4.1` では、WinGet はまだ公開されておらず、Windows release ZIP もまだ公開されていません。
...
現在の `v0.4.1` では、Chrome Web Store listing は公開済みで、extension version `0.4.1` を表示します。
