...
- macOS app: download pageとGitHub Releasesでsigned and notarized `v0.4.2` DMGを公開済み
- Chrome extension: Chrome Web Storeで`v0.4.3`を公開済み。更新日は2026年7月11日
...
とは別に記録します。現在のlistingはversion `0.4.3`、更新日は2026年7月11日です。
