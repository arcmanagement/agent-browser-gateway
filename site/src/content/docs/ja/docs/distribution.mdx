...
- macOS app: download pageとGitHub Releasesでsigned and notarized `v0.4.4` DMGを公開済み
...
現在の `v0.4.4` では、このpackageはまだWinGetにindexされていません。上のcommandがmatching packageなしを
