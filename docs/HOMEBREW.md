...
```text
dist/agent-browser-gateway-0.3.4-macos-arm64.zip
...
```bash
make dist VERSION=0.3.4 CASK_OUTPUT=Casks/agent-browser-gateway.rb
git add Casks/agent-browser-gateway.rb
git commit -m "Update Homebrew cask for v0.3.4"
git push
```
